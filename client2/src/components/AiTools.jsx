...
const AiTools = () => {
    ...
    const {user}=useUser();  // user ko laya clerk se login ke bad clerk ke pass hoga na
    ...
    <div className='px-4 sm:px-20 xl:px-32  my-24'>
        ...
        <div className='flex flex-wrap mt-10 justify-center'>
            {AiToolsData.map((tool, index) => (
                ...
                // user exist login/exist hoga to hi card pe click karne par aage ja sakte hai 
                >
                <tool.Icon 
